...
export const messages = {
  en: {
    ...
    guides: "Guides", canvasActions: "Canvas actions", datasetMetadata: "Dataset metadata", validationDiagnostics: "Validation diagnostics", graphViewControls: "Graph view controls", moveZoomControls: "Move zoom controls", collapseViewportControls: "Collapse viewport controls", expandViewportControls: "Expand viewport controls",
  ...
  ja: {
    ...
    guides: "ガイド", canvasActions: "キャンバス操作", datasetMetadata: "Dataset メタデータ", validationDiagnostics: "検証診断", graphViewControls: "グラフ表示操作", moveZoomControls: "ズーム操作を移動", collapseViewportControls: "表示操作を折りたたむ", expandViewportControls: "表示操作を展開する",
