...
export const messages = {
  en: {
    ...
    untitled: "Untitled",
    newDataset: "New Dataset", openSampleDataset: "Open sample Dataset", sampleInfo: "Sample info", sampleDatasetLoadFailure: "Could not load the sample Dataset.",
  ...
  ja: {
    ...
    newDataset: "新しいDataset", openSampleDataset: "サンプルDatasetを開く", sampleInfo: "サンプル情報", sampleDatasetLoadFailure: "サンプルDatasetを読み込めませんでした。",
