...
export const messages = {
  en: {
    ...
    footerDescriptor: "E2R relationship editor", credits: "Credits", closeCredits: "Close Credits", application: "Application", creator: "Creator", releaseDate: "Release date", releaseDatePending: "To be announced", aiAcknowledgement: "Created with the assistance of AI.", creditsLinks: "Credits links", liaisonScapeRepository: "LiaisonScape repository", e2rSpecificationRepository: "E2R specification repository",
  ...
  ja: {
    ...
    footerDescriptor: "E2Rリレーションシップエディター", credits: "クレジット", closeCredits: "クレジットを閉じる", application: "アプリケーション", creator: "作成者", releaseDate: "リリース日", releaseDatePending: "後日発表", aiAcknowledgement: "AIの支援を受けて作成しています。", creditsLinks: "クレジットリンク", liaisonScapeRepository: "LiaisonScapeリポジトリ", e2rSpecificationRepository: "E2R仕様リポジトリ",
    languageEnglish: "English",
    languageJapanese: "日本語",
