...
export const messages = {
  en: {
    ...
    pinState: "Pin",
    entityPinned: "Pinned",
    entityUnpinned: "Unpinned",
    pinEntity: "Pin",
    unpinEntity: "Unpin",
    saveCoordinates: "Save node coordinates",
    autoLayout: "Auto Layout",
    autoLayoutConfirmationTitle: "Replace unsaved positions?",
    autoLayoutConfirmationMessage: "Auto Layout will replace your unsaved Entity positions. Continue?",
    replacePositions: "Replace positions",
    cancelAutoLayout: "Cancel Auto Layout",
    explicitAutoLayoutRunning: "Calculating Auto Layout… Your current layout is unchanged.",
    explicitAutoLayoutReview: "Review Auto Layout",
    explicitAutoLayoutPreview: "Auto Layout preview — review before applying.",
    explicitAutoLayoutWarning: "This preview has presentation-quality warnings. You can still review or reject it.",
    acceptAutoLayout: "Apply layout",
    rejectAutoLayout: "Keep current layout",
    useAutoLayout: "Use this layout",
    returnToPreviousLayout: "Return to previous layout",
    explicitAutoLayoutFailed: "Auto Layout could not produce a safe preview. Your current layout was kept.",
    explicitAutoLayoutAccepted: "Auto Layout applied temporarily. Save node coordinates to persist it.",
    explicitAutoLayoutUnchanged: "The Auto Layout preview did not change Entity positions.",
    more: "More",
    ...
    targetedHandoffInvalid: "The targeted Dataset handoff link is invalid.",
    targetedHandoffTargetNotFound: "The requested Relation was not found in the Dataset.",
    targetedHandoffTargetTypeMismatch: "The requested target type does not match the Relation.",
    targetedHandoffCapabilityUnsupported: "LiaisonScape does not support the requested Handoff capability.",
    ...
    guides: "Guides", canvasActions: "Canvas actions", datasetMetadata: "Dataset metadata", validationDiagnostics: "Validation diagnostics", graphViewControls: "Graph view controls", moveZoomControls: "Move zoom controls", collapseViewportControls: "Collapse viewport controls", expandViewportControls: "Expand viewport controls", viewportToolbarMoveCollapseHelp: "Move\nCollapse", viewportToolbarMoveExpandHelp: "Move\nExpand", moveOrCollapseViewportControls: "Move or collapse viewport controls", moveOrExpandViewportControls: "Move or expand viewport controls",
    ...
    datasetTitleVisible: "Dataset title",
    applyDatasetTitle: "Apply title",
    datasetTitleInput: "Dataset title",
    untitled: "Untitled",
    newDataset: "New Dataset", openSampleDataset: "Open sample Dataset", sampleInfo: "Sample info", supportE2r: "Support E2R on GitHub Sponsors", sampleDatasetLoadFailure: "Could not load the sample Dataset.",
    datasetLoading: "Loading Dataset…",
    automaticPlacementPending: "Calculating automatic placement…",
    cancelAutomaticPlacement: "Cancel automatic placement",
    automaticPlacementCancelled: "Automatic placement cancelled; current layout kept.",
    automaticPlacementFallback: "Automatic placement unavailable; current layout kept.",
    ...
    relationDetailSource: "Source",
    relationDetailTarget: "Target",
  ...
  ja: {
    ...
    automaticPlacementPending: "\u81ea\u52d5\u914d\u7f6e\u3092\u8a08\u7b97\u4e2d\u2026",
    cancelAutomaticPlacement: "\u81ea\u52d5\u914d\u7f6e\u3092\u30ad\u30e3\u30f3\u30bb\u30eb",
    automaticPlacementCancelled: "\u81ea\u52d5\u914d\u7f6e\u3092\u30ad\u30e3\u30f3\u30bb\u30eb\u3057\u3001\u73fe\u5728\u306e\u30ec\u30a4\u30a2\u30a6\u30c8\u3092\u4fdd\u6301\u3057\u307e\u3057\u305f\u3002",
    automaticPlacementFallback: "\u81ea\u52d5\u914d\u7f6e\u3092\u5229\u7528\u3067\u304d\u306a\u3044\u305f\u3081\u3001\u73fe\u5728\u306e\u30ec\u30a4\u30a2\u30a6\u30c8\u3092\u4fdd\u6301\u3057\u307e\u3057\u305f\u3002",
    edit: "\u7de8\u96c6",
    datasetTitleVisible: "Dataset\u30bf\u30a4\u30c8\u30eb",
    ...
    targetedHandoffInvalid: "対象指定付きのDataset引き渡しリンクが正しくありません。",
    targetedHandoffTargetNotFound: "指定されたRelationがDataset内に見つかりません。",
    targetedHandoffTargetTypeMismatch: "指定された対象の型がRelationと一致しません。",
    targetedHandoffCapabilityUnsupported: "LiaisonScapeは指定されたHandoff機能に対応していません。",
    cancel: "キャンセル",
    ...
    pinState: "\u30d4\u30f3",
    entityPinned: "\u30d4\u30f3\u7559\u3081\u6e08\u307f",
    entityUnpinned: "\u30d4\u30f3\u7559\u3081\u306a\u3057",
    pinEntity: "\u30d4\u30f3\u7559\u3081",
    unpinEntity: "\u30d4\u30f3\u7559\u3081\u3092\u89e3\u9664",
    saveCoordinates: "座標を保存",
    autoLayout: "自動レイアウト",
    autoLayoutConfirmationTitle: "未保存の座標を置き換えますか？",
    autoLayoutConfirmationMessage: "自動レイアウトは未保存の Entity 座標を置き換えます。続行しますか？",
    replacePositions: "座標を置き換える",
    cancelAutoLayout: "自動レイアウトをキャンセル",
    explicitAutoLayoutRunning: "自動レイアウトを計算中… 現在の配置は変更されていません。",
    explicitAutoLayoutReview: "自動レイアウトを確認",
    explicitAutoLayoutPreview: "自動レイアウトのプレビュー—適用前に確認してください。",
    explicitAutoLayoutWarning: "このプレビューには表示品質の警告があります。確認または却下できます。",
    acceptAutoLayout: "レイアウトを適用",
    rejectAutoLayout: "現在の配置を維持",
    useAutoLayout: "このレイアウトを使う",
    returnToPreviousLayout: "元の配置に戻す",
    explicitAutoLayoutFailed: "安全なプレビューを作成できませんでした。現在の配置を維持しました。",
    explicitAutoLayoutAccepted: "自動レイアウトを一時的に適用しました。保存するにはノード座標を保存してください。",
    explicitAutoLayoutUnchanged: "プレビューで Entity 座標は変更されませんでした。",
    more: "その他",
    ...
    newDataset: "新しいDataset", openSampleDataset: "サンプルDatasetを開く", sampleInfo: "サンプル情報", supportE2r: "GitHub SponsorsでE2Rを支援する", sampleDatasetLoadFailure: "サンプルDatasetを読み込めませんでした。",
    openDataset: "E2R Datasetを開く",
    continueEditing: "編集を続ける",
    userGuide: "日本語ユーザーガイド",
    footerDescriptor: "E2Rリレーションシップエディター", credits: "クレジット", closeCredits: "クレジットを閉じる", application: "アプリケーション", creator: "作成者", firstRelease: "初回リリース", updated: "更新日", aiAcknowledgement: "このプロジェクトに貢献したすべてのAIシステムに感謝します。", creditsLinks: "クレジット関連リンク", liaisonScapeRepository: "LiaisonScapeリポジトリ", e2rSpecificationRepository: "E2R仕様リポジトリ",
    languageEnglish: "English",
    ...
    guides: "ガイド", canvasActions: "キャンバス操作", datasetMetadata: "Dataset メタデータ", validationDiagnostics: "検証診断", graphViewControls: "グラフ表示操作", moveZoomControls: "ズーム操作を移動", collapseViewportControls: "表示操作を折りたたむ", expandViewportControls: "表示操作を展開する", viewportToolbarMoveCollapseHelp: "移動\nたたむ", viewportToolbarMoveExpandHelp: "移動\n広げる", moveOrCollapseViewportControls: "表示操作を移動またはたたむ", moveOrExpandViewportControls: "表示操作を移動または広げる",
    ...
    relationDetailSource: "始点",
    relationDetailTarget: "終点",
